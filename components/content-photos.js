        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
          <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
            ...
            <p className="mt-6 text-xl leading-8 text-gray-600">
              When working with Giacchino in the 2000s, Chris wrote additional music for the TV series Alias, and also helped arrange & orchestrate various cues for a variety of film and TV projects, including The Imperial Suite for Giacchino&rsquo;s Rogue One: A Star Wars Story score.
            </p>
            <p className="mt-6 text-xl leading-8 text-gray-600">
          ...
          <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
            ...
            <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-[37rem] lg:items-start lg:justify-end lg:gap-x-8">
              ...
              <div className="flex w-84 flex-auto justify-end lg:w-auto lg:flex-none">
                <div className="aspect-[7/5] w-[32rem] max-w-none flex-none bg-gray-50 relative">
                  <Image
