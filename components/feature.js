...
export default function Feature() {
  return (
    <div className="overflow-hidden bg-white sm:rounded-md py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          {/* <div className="w-[48rem] max-w-none shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0 relative rounded-2xl"> */}
            <Image
              src="/images/ig-5.jpg"
              alt="consoles"
              width={1080}
