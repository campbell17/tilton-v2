...
const navigation = [
  {
    name: 'Twitter',
    href: 'https://twitter.com/christilton',
    icon: (props) => (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/christiltonmusic',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/christilton/',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: 'Mastodon',
    href: 'https://mastodon.world/@christilton',
    icon: (props) => (
      ...
      <div className={`mx-auto max-w-7xl px-6 md:flex md:items-center md:justify-between lg:px-8 ${props.light ? "pt-0 pb-12" : "py-12"}`}>
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-xs leading-5 text-gray-500">
            &copy; 2013 - {currentYear} Chris Tilton. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
