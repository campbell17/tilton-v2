export const projectData = [
  ...
  { 
    ...
    songsdata: [
      ...
      {
        "title": "Global Robotics Laboratories",
  ...
  { 
    ...
    ctalink: "https://open.spotify.com/album/705F6qKAhppVmgHKGo06ds?si=yAU9sAAMROaFZp4hZATP5g", 
  ...
  { 
    ...
    ctalink: "https://www.paramountplus.com/shows/zoo/", 
    ...
    songsdata: [
      {
        "title": "Welcome to Pangea",
        "url": "/music/christilton_zoo_01_welcome-to-pangea.mp3" 
      },
      {
        "title": "Lion Attack",
      ...
      {
        "title": "Hell Hath Rhino Fury",
        "url": "/music/christilton_zoo_04_hell-hath-rhino-fury.mp3" 
      },
      {
        "title": "Freed the Birds",
        "url": "/music/christilton_zoo_05_freed-the-birds.mp3"
      }
    ],
  },  
  { 
    ...
    subtitle: "",
    cta: "Listen on Spotify", 
    ctalink: "https://open.spotify.com/album/7dxKI9RCXe3tL9WrmLknPe", 
    ctabrand: "bg-[#1DB954] hover:bg-[#1DB954]",
    ctaicon: "Spotify", 
    year: "2017", 
    ...
    songsdata: [
      ...
      {
        "title": "Divided (feat. Tori Letzler)",
  ...
  { 
    ...
    subtitle: "",
    cta: "Listen on Spotify", 
    ctalink: "https://open.spotify.com/album/3twvifqyfIqxysNP4gT3A6?si=jDA9BXQOT1yiUWhAwJL13A", 
    ctabrand: "bg-[#1DB954] hover:bg-[#1DB954]",
    ctaicon: "Spotify", 
    year: "2013", 
  ...
  { 
    ...
    subtitle: "",
    cta: "Listen on Spotify",
    ctalink: "https://open.spotify.com/album/2pq9yqj3HnliNy5yRhOvFt?si=L5k6yBbJToamQ2Mx_nSrGQ", 
    ctabrand: "bg-[#1DB954] hover:bg-[#1DB954]", 
    ctaicon: "Spotify", 
    year: "2019", 
    ...
    songsdata: [
      ...
      {
        "title": "Building the Foundation [Excerpt]",
      ...
      {
        "title": "Clean Build of Health [Excerpt]",
        "url": "/music/christilton_simcity_04_clean-build-of-health_excerpt.mp3" 
      },
      {
        "title": "A Tale of Sim Cities [Excerpt]",
        "url": "/music/christilton_simcity_05_a-tale-of-sim-cities_excerpt.mp3"
      }
    ],
  },
  ...
  { 
    ...
    subtitle: "",
    cta: "Listen on Spotify",
    ctalink: "https://open.spotify.com/album/7IrJy1SU3p4M70P2cPbP4Z?si=LXNMKLX5Su2HGWV7rwjcnw", 
    ctabrand: "bg-[#1DB954] hover:bg-[#1DB954]", 
    ctaicon: "Spotify", 
    year: "2020", 
    ...
    songsdata: [
      ...
      {
        "title": "Forest of Dreams [Excerpt]",
        "url": "/music/christilton_fringe_02_forest-of-dreams_excerpt.mp3" 
      },
      {
        "title": "Gurney for Your Thoughts [Excerpt]",
        "url": "/music/christilton_fringe_03_gurney-for-your-thoughts_excerpt.mp3" 
      },
      {
        "title": "Newton's Last Mission [Excerpt]",
        "url": "/music/christilton_fringe_04_newtons-last-mission_excerpt.mp3" 
      },
      {
  ...
  { 
    ...
    credits: "Co-Composed with Andrea Datzman, Michael Giacchino",
  ...
  { 
    ...
    ctalink: "https://christilton.com/assets/files/music/downloads/cover-soundtrack.zip", 
    ctabrand: "",
    ctaicon: "Download", 
    year: "2011", 
  ...
  { 
    ...
    cta: "Download Soundtrack", 
    ctalink: "https://christilton.com/assets/files/music/downloads/night-at-the-museum-battle-of-the-smithsonian-soundtrack.zip", 
    ctabrand: "",
    ctaicon: "Download", 
    year: "2009", 
  ...
  { 
    ...
    credits: "Co-composed with Chad Seiter, Michael Giacchino",
    ...
    subtitle: "",
    cta: "Download Soundtrack", 
    ctalink: "https://christilton.com/assets/files/music/downloads/fracture-soundtrack.zip", 
    ctabrand: "",
    ctaicon: "Download", 
    year: "2008", 
  ...
  { 
    ...
    subtitle: "",
    cta: "Listen on Spotify", 
    ctalink: "https://open.spotify.com/album/4TclQb4N62hFIODELcyax8?si=UnJ3Y69PR86D5OXFOlfTag", 
    ctabrand: "bg-[#1DB954] hover:bg-[#1DB954]",
    ctaicon: "Spotify", 
    year: "2008", 
...

  {
    ...
    cta: "Download Soundtrack",
    ctalink: "",
    ctabrand: "https://christilton.com/assets/files/music/downloads/jumper-griffins-story-soundtrack.zip",
    ctaicon: "Download",
    year: "2008",
    ...
    songsdata: [
      { "title": "Griffin's Story", "url": "/music/christilton_jumper_01_griffins-story.mp3" },
      { "title": "Path to Roland", "url": "/music/christilton_jumper_02_path-to-roland.mp3" },
      { "title": "Network Breach", "url": "/music/christilton_jumper_03_network-breach.mp3" },
      { "title": "Tokyo Dockside", "url": "/music/christilton_jumper_04_tokyo-dockside.mp3" },
      { "title": "Final Confrontation", "url": "/music/christilton_jumper_05_final-confrontation.mp3" }
    ]
  },
  
  {
    ...
    subtitle: "",
    cta: "Download Soundtrack",
    ctalink: "https://christilton.com/assets/files/music/downloads/la-lune-soundtrack.zip",
    ctabrand: "",
    ctaicon: "Download",
    year: "2008",
    desc: "In this magical fairy tale, two minature lovers seek the sun from atop a crumbling hourgalss.",
    songsdata: [
      { "title": "Opening", "url": "/music/christilton_lalune_01_opening.mp3" },
      { "title": "Shoot for the Lune", "url": "/music/christilton_lalune_02_shoot-for-the-lune.mp3" },
      { "title": "The Hourglass", "url": "/music/christilton_lalune_03_the-hourglass.mp3" },
      { "title": "End Titles", "url": "/music/christilton_lalune_04_end-titles.mp3" },
      { "title": "La Lune Full Score", "url": "/music/christilton_lalune_05_la-lune-full-score.mp3" }
    ]
  },
  {
    id: 17,
    ...
    subtitle: "",
    cta: "Download Soundtrack",
    ctalink: "https://christilton.com/assets/files/music/downloads/sunday-man-soundtrack.zip",
    ctabrand: "",
    ctaicon: "Download",
    year: "2007",
    desc: "The misadventures of a remarkably peculiar man, who has some very unusual ideas about who he is.",
    songsdata: [
      { "title": "Opening Titles", "url": "/music/christilton_sundayman_01_opening-titles.mp3" },
      { "title": "My Mom's a Hugger", "url": "/music/christilton_sundayman_02_my-moms-a-hugger.mp3" },
      { "title": "Bible Study", "url": "/music/christilton_sundayman_03_bible-study.mp3" },
      { "title": "Miracle Man", "url": "/music/christilton_sundayman_04_miracle-man.mp3" },
      { "title": "The Sunday Man", "url": "/music/christilton_sundayman_05_the-sunday-man.mp3" }
    ]
  },
  {
    id: 18,
    ...
    credits: "Main Theme co-composed with Michael Giacchino",
    ...
    subtitle: "",
    cta: "Listen on Spotify",
    ctalink: "https://open.spotify.com/album/1sdCaucgnNRQRkNbp7PQ3P?si=40ASt_tqTK6JwrgOVBQUYQ",
    ctabrand: "bg-[#1DB954] hover:bg-[#1DB954]",
    ctaicon: "Spotify",
    year: "2006",
  ...
  },
  {
    ...
    credits: "Co-composed with Michael Giacchino",
  ...
  },
  {
    ...
    subtitle: "",
    cta: "Download Soundtrack",
    ctalink: "https://christilton.com/assets/files/music/downloads/muppets-party-cruise-soundtrack.zip",
    ctabrand: "", 
    ctaicon: "Download",
    year: "2003",
