                          ...
                          <div className="sm:ml-6 mt-4 sm:mt-0 text-white flex flex-col">
                            ...
                            <div className="mt-5 flex justify-center sm:justify-start flex-wrap space-y-3 sm:space-y-0 sm:space-x-3">
                              <a
                                ...
                                className={`cursor-pointer flex items-center justify-center rounded-md border border-transparent  px-4 py-2 pl-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-100 ${props.ctabrand}`}
                              >
