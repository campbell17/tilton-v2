...
export default function TrackListItem(props) {
  ...
  return (
    <button
      ...
      image={props.image}  
      type="button"
      className={`border-b border-indigo-600 pl-4 text-white text-xs flex text-left items-center w-full gap-1 shadow-sm bg-indigo-800 hover:bg-indigo-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ${props.image ? "" : "p-3"}`}
