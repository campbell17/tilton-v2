...
export default function TrackListItem(props) {
  ...
  return (
    ...
    >
      <span onClick={props.trackClickHandler} url={props.url} title={props.title} project={props.project} image={props.image} className="flex w-full">
        ...
        {props.project ? <span onClick={props.trackClickHandler} project={props.project} image={props.image} className="text-indigo-400 pointer-events-none">{props.project}</span> : null}
      </span>
    {props.image ? 
