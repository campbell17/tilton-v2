...
export default function Home() {
  return (
    <div className="relative overflow-hidden bg-sky-900">
      <div className="mx-auto max-w-7xl">
        <div className="relative z-10 bg-sky-900 pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
          <svg
            className="absolute inset-y-0 right-0 hidden h-full w-48 translate-x-1/2 transform text-sky-900 lg:block"
            fill="currentColor"
            viewBox="0 0 100 100"
              ...
              <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                <div className="flex flex-shrink-0 flex-grow items-center lg:flex-grow-0">
                  <div className="flex w-full items-center justify-between md:w-auto">
                    <a href="#">
                      <span className="sr-only">Chris Tilton, Composer</span>
                      <div className="h-7 w-36 relative">
                        <Image
                          alt="Chris Tilton, Composer"
                          className=""
                ...
                <div className="hidden md:ml-10 md:block md:space-x-8 md:pr-4">
                  {navigation.map((item) => (
                    <a key={item.name} href={item.href} className="font-medium text-white hover:text-sky-400">
                      {item.name}
                    </a>
                  ))}
                </div>
          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                <span className="block text-stone-200 xl:inline">Chris Tilton</span>
              </h1>
